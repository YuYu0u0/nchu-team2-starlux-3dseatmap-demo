...
const cameraTargets = {
  'ED_02E': {
    position: new THREE.Vector3(-0.26, 1.22, -9.7),
    target: new THREE.Vector3(-0.21, 1.54, -4.84),
    title: '02E',
    class: "豪華經濟艙",
    text: '相鄰的中央豪華經濟艙座位，提供更寬敞的腿部空間與舒適度，適合與旅伴同行。升降式隔板設計，讓您在互動與隱私之間輕鬆切換。'
  },
  'ED_04A': {
    position: new THREE.Vector3(1.18, 1.22, -10.8),
    target: new THREE.Vector3(1.23, 1.54, -4.84),
    title: '04A',
    class: "豪華經濟艙",
    text: '靠窗的豪華經濟艙座位，擁有更寬敞的伸展空間，讓您獨享雲端景致，旅途不受打擾。升級的座椅設計，提供更佳的乘坐體驗。'
  },
  'ED_04D': {
    ...
    title: '04D',
    class: "豪華經濟艙",
    text: '配置於走道旁的豪華經濟艙座位，進出更為從容。加大的座椅寬度與傾斜角度，提供介於經濟艙與商務艙之間的舒適休憩空間。'
  },
};
// ===================================================================
