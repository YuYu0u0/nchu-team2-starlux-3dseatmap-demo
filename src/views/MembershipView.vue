<template>
    <div class="page-container">
        ...
        <!-- Main 內容區塊 -->
        <main class="container membership-page">
            ...
            <section class="notice-section">
                <h2 class="f2">注意事項</h2>
                <ol>
                    <li>會員資格有效期為入會日起一年。</li>
                    <li>里程累積與升等規則依航空公司公告為準。</li>
                    <li>會員優惠不得與其他促銷併用。</li>
                </ol>
            </section>
