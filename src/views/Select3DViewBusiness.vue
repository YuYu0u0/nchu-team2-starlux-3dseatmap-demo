...
const cameraTargets = {
  'ED_02E': {
    position: new THREE.Vector3(-0.26, 1.22, -9.82),
    target: new THREE.Vector3(-0.21, 1.54, -4.84),
    title: '02E',
    class: "商務艙",
    text: '相鄰的中央商務艙座位，適合與旅伴同行。升降式隔板設計，讓您在互動與隱私之間輕鬆切換。'
  },
  'ED_04A': {
    position: new THREE.Vector3(1.18, 1.22, -11),
    target: new THREE.Vector3(1.23, 1.54, -4.84),
    title: '04A',
    class: "商務艙",
    text: '靠窗的商務艙座位，讓您獨享雲端景致，旅途不受打擾。配備可完全平躺的座椅，打造專屬的舒適休憩領域。'
  },
  'ED_04D': {
    position: new THREE.Vector3(0.1, 1.22, -11),
    target: new THREE.Vector3(0.52, 1.54, -4.84),
    title: '04D',
    class: "商務艙",
    text: '配置於走道旁的商務艙座位，讓您進出更為從容。寬敞的座椅設計，提供舒適的辦公與休憩空間。'
  },
};
// ===================================================================
...
const initThreeScene = () => {
  ...
  const directionalLight = new THREE.DirectionalLight(0xffffff, 8); // 調整第二個參數 (2.5) 可以改變方向光的亮度
  ...
  camera.position.set(-0.37, 3.34, -8.13); // 更新初始攝影機位置
